  ...
  return (
    ...
    >
      ...
      <View style={styles.ingredientsContainer}>
        ...
        <Text style={styles.subIngredient}>{props.toasted ? "Toasted" : ""}</Text>
        <Text style={styles.subIngredient}>{props.doubleMeat ? "Double Meat" : ""}</Text>
        <Text style={styles.subIngredient}>{props.doubleCheese ? "Double Cheese" : ""}</Text>
        <Text style={styles.subIngredient}>{props.mealCombo ? "Meal Combo" : ""}</Text>
      </View>
